const { TaskComments } = require("./taskComments.class");
const createModel = require("./taskComments.model");
const hooks = require("./taskComments.hooks");
...
module.exports = function (app) {
  ...
  app.use("/taskComments", new TaskComments(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("taskComments");

  // Get the schema of the collections 
  app.get("/taskCommentsSchema", function (request, response) {
