const { TaskReminders } = require("./taskReminders.class");
const createModel = require("./taskReminders.model");
const hooks = require("./taskReminders.hooks");
...
module.exports = function (app) {
  ...
  app.use("/taskReminders", new TaskReminders(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("taskReminders");

  // Get the schema of the collections 
  app.get("/taskRemindersSchema", function (request, response) {
