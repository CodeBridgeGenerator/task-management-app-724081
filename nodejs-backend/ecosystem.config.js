...
module.exports = {
    apps: [
        {
            // name: cwd + "-" + "task-management-app",
            script: 'src/',
            instance_var: 'INSTANCE_ID',
            appendEnvToName: true,
            // Standard Output (console.log) will go here
            //out_file: "/home/ubuntu/app/logs/task-management-appstg-out.log",
            // Error Output (console.error) will go here
            //error_file: "/home/ubuntu/app/logs/task-management-app-stg-error.log",
