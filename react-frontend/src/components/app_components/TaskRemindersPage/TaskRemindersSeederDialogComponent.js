...
import seederData from "./taskReminders.seeder.json";
...
const TaskRemindersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TaskRemindersSeederDialogComponent);
