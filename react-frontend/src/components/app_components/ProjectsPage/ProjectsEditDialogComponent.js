...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <MultiSelect id="members" value={_entity?.members?.map((i) =>i._id)} options={membersOptions} optionLabel="name" optionValue="value" onChange={(e) => setValByKey("members", e.value)}  />
            </span>
            <small className="p-error">
