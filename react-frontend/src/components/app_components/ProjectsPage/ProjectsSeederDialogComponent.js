...
import seederData from "./projects.seeder.json";
...
const ProjectsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProjectsSeederDialogComponent);
