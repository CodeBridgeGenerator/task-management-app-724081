...
import seederData from "./taskComments.seeder.json";
...
const TaskCommentsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TaskCommentsSeederDialogComponent);
