...
import taskCommentsFakerFactory from "./taskCommentsFakerFactory";
...
const TaskCommentsFakerDialogComponent = (props) => {
...
client.service("users")
    ...
    const onRun = async () => {
        let fakeData = taskCommentsFakerFactory(props.user,fakerCount,taskIds,authorIds);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("taskComments").create(elem));
...
export default connect(mapState, mapDispatch)(TaskCommentsFakerDialogComponent);
